...
public class MsmeUserDetailaRequestDTONotValidAttributeProvider implements ArgumentsProvider {
    /**
        ...
        return Stream.of(
                Arguments.of(UUID.fromString("c27d54a6-a2fc-4146-8dc3-35cfa69f25eb"),
                        MsmeUserDetailsRequestDTO
                                .builder()
                                .category(UUID.fromString("62833a96-32fd-44e9-8926-182a799dc6e4"))
                ...
                Arguments.of(UUID.fromString("c27d54a6-a2fc-4146-8dc3-35cfa69f25eb"),
                        MsmeUserDetailsRequestDTO
                                ...
                                .educationalQualification(UUID.fromString("4359b425-d47e-41b1-b794-6a2e396fd044"))
                                .gender(UUID.fromString("ec78a3d8-2fff-4867-ba91-4290fca86635"))
                                .maritalStatus(UUID.fromString("6f3bf095-3c73-4443-a9d0-694cb2b9bec1")).build()),
                Arguments.of(UUID.fromString("c27d54a6-a2fc-4146-8dc3-35cfa69f25eb"),
                        MsmeUserDetailsRequestDTO
                                ...
                                .category(UUID.fromString("62833a96-32fd-44e9-8926-182a799dc6e6"))
                                .educationalQualification(UUID.fromString("4359b425-d47e-41b1-b794-6a2e396fd040"))
                                .gender(UUID.fromString("ec78a3d8-2fff-4867-ba91-4290fca86634"))
                                .maritalStatus(UUID.fromString("6f3bf095-3c73-4443-a9d0-694cb2b9bec1")).build()),
                Arguments.of(UUID.fromString("c27d54a6-a2fc-4146-8dc3-35cfa69f25eb"),
                        MsmeUserDetailsRequestDTO
                                .builder()
                                ...
                                .educationalQualification(UUID.fromString("4359b425-d47e-41b1-b794-6a2e396fd040"))
                                .gender(UUID.fromString("ec78a3d8-2fff-4867-ba91-4290fca86635"))
                                .maritalStatus(UUID.fromString("6f3bf095-3c73-4443-a9d0-694cb2b9bec4")).build())
        );
    }
}
